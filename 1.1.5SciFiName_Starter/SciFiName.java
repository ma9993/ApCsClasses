...
public class SciFiName   
{
    ...
    public static void main()
    {
        ...
        System.out.println("Your first name is now:" + firstName + lastName);
        
        city = city.substring(0,3);
        school = school.substring(0,4);
        System.out.println("Your last name is now:" + city + school);
        
        int relativenamenum = relativeName1.length();
        relativeName1 = relativeName1.substring(Math.random();
